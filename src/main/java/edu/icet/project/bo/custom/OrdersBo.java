...
public interface OrdersBo extends SuperBo {
    ...
    boolean deleteOrder(Orders order, List<OrdersDetails> ordersDetailsList, List<Product> productsList);

    List<OrdersDetails> searchAllOrderProductByOrderId(Integer id);
    OrdersDetails searchOrderProductById(Integer id);
    boolean deleteOrderProduct(OrdersDetails oProduct, Product product);
